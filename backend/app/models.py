...
class Nomenclature(Base, TimestampMixin):
    ...
    kit_article: Mapped[Optional[str]] = mapped_column(String(128), nullable=True)
    card_created_at: Mapped[Optional[date]] = mapped_column(Date, nullable=True)
    default_characteristic: Mapped[Optional[str]] = mapped_column(String(256), nullable=True)
...
class Counterparty(Base, TimestampMixin):
    ...
    legal_status: Mapped[Optional[str]] = mapped_column(String(64), nullable=True)
    is_buyer: Mapped[bool] = mapped_column(Boolean, default=False)
    is_supplier: Mapped[bool] = mapped_column(Boolean, default=False)
    iin: Mapped[Optional[str]] = mapped_column(String(32), nullable=True)
    identity_document: Mapped[Optional[str]] = mapped_column(String(512), nullable=True)
    rnn: Mapped[Optional[str]] = mapped_column(String(32), nullable=True)
    sik: Mapped[Optional[str]] = mapped_column(String(32), nullable=True)
    okpo: Mapped[Optional[str]] = mapped_column(String(32), nullable=True)
    kbe: Mapped[Optional[str]] = mapped_column(String(16), nullable=True)
