...
Краткие инструкции по ролям для сервиса «Акции по клиентам».
...
Пользовательские гайды по ролям: [guides/README.md](guides/README.md).

Вход (dev): email/пароль из `.env` (`ADMIN_EMAIL` / `ADMIN_PASSWORD`).
